...
public class PatientServiceTest extends BaseContextSensitiveTest {
    ...
    @Test
    @Verifies(value = "should throw an APIException if the given name is null", method="searchPatient(String")
    public void searchPatient_shouldThrowAnAPIExceptionIftheGivenNameIsNull() throws Exception {
        executeDataSet(CREATE_PATIENT_XML);
        ...
        List<Patient> patients = service.searchPatient("John");
        assertEquals(1, patients.size());
    }
